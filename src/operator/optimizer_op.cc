...
.set_attr<FCompute>("FCompute<cpu>", MultiMomUpdate<cpu, type_identity, 3, MultiSGDKernel>)
...
.set_attr<FCompute>("FCompute<cpu>", MultiMomUpdate<cpu, single_precision, 4, MultiSGDKernel>)
.add_argument("data", "NDArray-or-Symbol[]", "Weights")
.add_arguments(MultiSGDMomParam::__FIELDS__());
...
.set_attr<FCompute>("FCompute<cpu>", MultiMomUpdate<cpu, type_identity, 3, MultiNAGKernel>)
.add_argument("data", "NDArray-or-Symbol[]", "Weights, gradients and momentum")
.add_arguments(MultiSGDMomParam::__FIELDS__());
...
.set_attr<FCompute>("FCompute<cpu>", MultiMomUpdate<cpu, single_precision, 4, MultiNAGKernel>)
.add_argument("data", "NDArray-or-Symbol[]", "Weights")
.add_arguments(MultiSGDMomParam::__FIELDS__());
