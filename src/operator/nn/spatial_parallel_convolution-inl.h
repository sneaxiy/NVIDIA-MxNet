...
*/
#ifndef MXNET_OPERATOR_NN_SPATIAL_PARALLEL_CONVOLUTION_INL_H_
#define MXNET_OPERATOR_NN_SPATIAL_PARALLEL_CONVOLUTION_INL_H_
...
namespace spconv {
enum ConvolutionOpInputs {kData, kWeight, kDummy, kBias};
...
#endif  // MXNET_OPERATOR_NN_SPATIAL_PARALLEL_CONVOLUTION_INL_H_
