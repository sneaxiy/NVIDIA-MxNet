...
protected:
  ...
  void  ScaleMemcpyToOutput(const std::vector<TensorTableEntry>& entries, double scale_factor);

  void  ScaleOutput(const std::vector<TensorTableEntry>& entries, double scale_factor);
#endif
