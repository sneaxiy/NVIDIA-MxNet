...
def _TensorRT(name=None, attr=None, out=None, **kwargs):
    r"""TRT operation (one engine)


    Defined in ../src/operator/subgraph/tensorrt/tensorrt.cc:L376
...
def _backward_BNStatsFinalize(name=None, attr=None, out=None, **kwargs):
    r"""
...
def _backward_BatchNormAddRelu(name=None, attr=None, out=None, **kwargs):
    r"""
...
def _backward_InstanceNormV2(name=None, attr=None, out=None, **kwargs):
    r"""
...
def _backward_NormConvolution(name=None, attr=None, out=None, **kwargs):
    r"""
...
def _backward_NormalizedConvolution(name=None, attr=None, out=None, **kwargs):
    r"""
...
def _backward_SPConvolution(name=None, attr=None, out=None, **kwargs):
    r"""
...
def _backward_ScaleBiasAddRelu(name=None, attr=None, out=None, **kwargs):
    r"""
...
def _crop_assign(lhs=None, rhs=None, begin=_Null, end=_Null, step=_Null, name=None, attr=None, out=None, **kwargs):
    ...
    From:../src/operator/tensor/matrix_op.cc:527
...
def _crop_assign_scalar(data=None, scalar=_Null, begin=_Null, end=_Null, step=_Null, name=None, attr=None, out=None, **kwargs):
    ...
    From:../src/operator/tensor/matrix_op.cc:553
...
def _multi_adamw_update(*data, **kwargs):
    r"""Parallel update function for AdamW optimizer. AdamW is seen as a modification of
    Adam by decoupling the weight decay from the optimization steps taken w.r.t. the loss function.

    Operator is launched for multiple tuples of parameters (weight, grad, m, v){j}.

    For each tuple (weight, grad, m, v), where g represents gradient and m, v
    are 1st and 2nd order moment estimates (mean and variance)

    Adam update consists of the following steps:
    ...
    Defined in ../src/operator/contrib/adamw.cc:L169
...
def _multi_mp_adamw_update(*data, **kwargs):
    ...
    Defined in ../src/operator/contrib/adamw.cc:L225
