...
class Symbol(SymbolBase):
    ...
    def simple_bind(self, ctx, grad_req='write', type_dict=None, stype_dict=None,
        ...
        if _int64_enabled():
            executor = _LIB.MXExecutorSimpleBindEx64
            provided_arg_shape_data = c_array_buf(mx_int64, array('q', provided_arg_shape_data))
        else:
            executor = _LIB.MXExecutorSimpleBindEx
            provided_arg_shape_data = c_array_buf(mx_int, array('I', provided_arg_shape_data))
        ...
        try:
            check_call(executor(self.handle,
                                ...
                                c_array_buf(mx_uint, array('i', provided_arg_shape_idx)),
