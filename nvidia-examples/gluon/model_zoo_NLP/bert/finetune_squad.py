...
def log_file_name(log_file_name_arg):
    return os.path.join(log_file_name_arg, 'finetune_squad.log')
...
if __name__ == '__main__':
    ...
    fh = logging.FileHandler(log_file_name(args.output_dir), mode='w')
    ...
    bert, vocab = get_model(model_name, dataset_name, pretrained, ctx, False, logging, vocab=vocab)
...
if __name__ == '__main__':
    ...
    report_train_time(start, log_file_name, args.output_dir)