...
python ../gluon_train_imagenet.py \
  ...
  --lr 0.4 --lr-mode cosine --num-epochs $NUM_EPOCHS --batch-size 128 --num-gpus $NUM_GPUS -j 90 \
  --use-rec --dtype $DTYPE --warmup-epochs $WARM_EPOCHS --last-gamma --no-wd --label-smoothing --mixup \
